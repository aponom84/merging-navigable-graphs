...
% Тут надо написать не криво. И сказать, что 
...
In our experiment as recall@5 we report an averaged value over all sequence of searches. 
...
% TODO И тут надо сказать, что нас удивило, что ITGM показал лучшую производительность, чем CTGM. Поскольку мы ожидали, что CTGM будет производительно из того, что он имеет возможность выбирать следущую "опорную" вершину среди обеих графов и имеет меньше шансов застрять, и следовательно сделать меньше дорогостоящих операций полного поиска. По всей видимости выбор "главной" вершины в CGTM слишком дорогая операцией. И эти затраты не окупаются, сокращением числа полных поисков при "застревании".
