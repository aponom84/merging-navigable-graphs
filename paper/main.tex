...
Finally, future work can be applied to develop a fast graph construction procedure using one of the merge algorithms. It seems very naturally to start from the set of small graphs and merge them in a recursive manner.
