...
%TODO здесь надо сказать, именно проважность задачи k-nn для прирожений. Упомянть про RAG, а далее уже перейти к формальной постановке задаче и какие методы для её решения бывают. Далее надо сказать про после того, как было упомянуто про графовые методы, сказать что там етсь задача объединения графов построенных на разных данных. В частности это может быть важно при compaction. 
